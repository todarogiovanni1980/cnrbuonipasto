...
/**
 * Helper for mod_cnrbuonipasto
 *
 * @package     com_cnrbuonipasto
 * @subpackage  mod_cnrbuonipasto
 * @since       1.6
 */
class ModCnrbuonipastoHelper
{
	/**
	...
	{
		return JText::_(
			'MOD_CNRBUONIPASTO_HEADER_FIELD_' . str_replace('#__', '', strtoupper($params->get('table'))) . '_' . strtoupper($field)
		);
	}
